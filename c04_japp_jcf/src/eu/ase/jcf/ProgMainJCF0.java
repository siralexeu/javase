...
class Human{
	...
	void print() {
        System.out.println("Huamn - cnp:" + this.cnp );
	}
	public int getCnp() {return cnp;}
}
class Student extends Human {
    private int grupa;
    public Student(int cnp, int grupa) {
        super(cnp);
        this.grupa = grupa;
    }
    void print() {
        System.out.println("Student - cnp: " + this.getCnp() + ", grupa = " + grupa);
    }
    public int getCnp() { return super.getCnp(); }
}
