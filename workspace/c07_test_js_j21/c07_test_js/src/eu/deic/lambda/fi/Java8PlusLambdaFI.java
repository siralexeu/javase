...
class MathOpClass {
	public int operate(int a, int b, MathOp mathOperation) {
...
public class Java8PlusLambdaFI {
	...
	public static void main(String[] args) {
        ...
        MathOpClass objM = new MathOpClass();
        MathOp div1 = (int a, int b) -> {
        	var result = a/b;
        	return result;
        };
        MathOp div2 = (a, b) -> a/b;
        System.out.println("\n Non generic 10 / 3 - div 1 = " + objM.operate(10, 3, div1) 
        			+ ", div2 = " + objM.operate(10, 3, div2));
